...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-center"><h4>Validation</h4></div>
                <div class="card-body">
                    <?php if (!empty($success)): ?>
                        <div class="alert alert-success">Validation réussie ✅</div>
                        <p>Email validé : <strong><?= htmlspecialchars($values['email'] ?? '') ?></strong></p>
                    <?php else: ?>
                        <div class="alert alert-danger">Erreur de validation.</div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
